...
func (s *FullNodeStruct) MpoolSubFox(p0 context.Context) (<-chan MpoolUpdateFox, error) {
...
func (s *FullNodeStub) MpoolSubFox(p0 context.Context) (<-chan MpoolUpdateFox, error) {
	return nil, ErrNotSupported
}
