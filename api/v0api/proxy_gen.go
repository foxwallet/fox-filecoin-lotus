...
func (s *FullNodeStruct) MpoolPendingFox(p0 context.Context, p1 types.TipSetKey) ([]*api.SignedMessageFox, error) {
	if s.Internal.MpoolPendingFox == nil {
		return *new([]*api.SignedMessageFox), ErrNotSupported
	}
	return s.Internal.MpoolPendingFox(p0, p1)
}

func (s *FullNodeStub) MpoolPendingFox(p0 context.Context, p1 types.TipSetKey) ([]*api.SignedMessageFox, error) {
	return *new([]*api.SignedMessageFox), ErrNotSupported
}
